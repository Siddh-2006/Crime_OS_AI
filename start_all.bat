...
echo 6. Starting Indic Translation Model (Sarvam on Port 8005)...
start "Sarvam Translation (8005)" cmd /k "echo Starting llama-server for Sarvam-1... && llama-server -m sarvam-1.Q8_0.gguf -c 2048 --port 8005"
