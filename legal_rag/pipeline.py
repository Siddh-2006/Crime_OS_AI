...
class LegalRAGPipeline:
    ...
    def retrieve(self, complaint: str, *, top_k: int = 15, final_k: int = 5, act_filter: Sequence[str] | None = None) -> LegalRetrievalBundle:
        return self.retriever.retrieve(complaint, top_k=top_k, final_k=final_k, act_filter=act_filter)

    def analyze(self, complaint: str, *, top_k: int = 15, final_k: int = 5, act_filter: Sequence[str] | None = None) -> LegalAnalysisResult:
    ...
    def answer(self, complaint: str, *, top_k: int = 15, final_k: int = 5, act_filter: Sequence[str] | None = None) -> dict:
